	...
	return (
		<div className="mx-auto flex h-full max-w-2xl flex-col gap-6 overflow-y-auto">
			...
			<form onSubmit={handleURLSubmit} className="flex gap-2">
				...
				/>
				<Button type="submit" variant="outline" disabled={!urlValue.trim() || isIngesting}>
					Ingest URL
				</Button>
			</form>
			...
			<div className="flex flex-col gap-1">
				...
				{isLoading ? (
					...
					<div className="py-8 text-center text-sm text-gray-400">No documents ingested yet</div>
				) : (
